...
import EtudiantListEvaluations from '../views/etudiants/bulletin_notes/evaluations';
...
import NiveauxStat from '../views/fondateur/statistique/statniveau';
...
import ListClassesEvalStat from '../views/fondateur/statistique/statclasseeval';
import StatListEvaluationsEtab from '../views/fondateur/statistique/evaluationsetab';
import ListEtabEvalStat from '../views/fondateur/statistique/statetabeval';
...
export const DefaultRouter = [
    ...
    //////
       ...
       ////////////////////////////////// Université
                ...
                ////////////////////////// etudiants
            {
                ...
                element: <EtudiantListEvaluations />
            },
            {
    ...
    ///oct 25
            ...
            {
                path: 'Admin/stat/:classe',
                element: <ChoixClassesStat />
            },

            {
                path: 'Admin/stat/:classe/elève',
                element: <ClassesStat />
            },
            {
            ...
            },
           {
            ...
            {
                path: 'Admin/stat/etablissement',
                element: <ChoixStatetab />
            },
            ...
            {
                path: 'Admin/stat/:classe/:evaluation',
                element: <ListClassesEvalStat />
            },

            {
                path: 'Admin/stat/etablissement/evaluation',
                element: <StatListEvaluationsEtab />
            },

            {
                path: 'Admin/stat/etablissement/:evaluation',
                element: <ListEtabEvalStat />
            }
