        ...
        <Fragment>
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                {user.role === "Super adminstrateur" ? (<div>
                            ...
                            <ul className="sub-nav">
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link " to="documents">
                                        ...
                                        <i className="sidenav-mini-icon"> D </i>
                                        <span className="item-name">documents_eleve</span>
                                    </Link>
                                </li>
                    ...
                    <Accordion.Item as="li" eventKey="ad-vitrine" bsPrefix={`nav-item mb-5 ${active === 'icons' ? 'active' : ''} `} onClick={() => setActive('icons')}>
                        <CustomToggle eventKey="ad-vitrine" onClick={(activeKey) => setActiveMenu(activeKey)}>
                            <i className="icon">
                            ...
                            <span className="item-name">Etablissment</span>
                            <i className="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                </svg>
                        ...
                        <Accordion.Collapse eventKey="ad-vitrine">
                            <ul className="sub-nav">
                                <li className="nav-item">
                                    <Link className={`${location.pathname === '/dashboard/icon/solid' ? 'active' : ''} nav-link`} to="/dashboard/icon/solid">
                                        ...
                                        <span className="item-name">Information</span>
                                    </Link>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <Link className={`${location.pathname === '/dashboard/icon/dual-tone' ? 'active' : ''} nav-link`} to="/dashboard/icon/dual-tone">
                                        ...
                                        <i className="sidenav-mini-icon"> D </i>
                                        <span className="item-name">Vitrine</span>
                                    </Link>
                                </li>
                            </ul>
                        </Accordion.Collapse>
                    ...
                    <Accordion.Item as="li" eventKey="Ad-Re" bsPrefix={`nav-item ${active === 'form' ? 'active' : ''} `} onClick={() => setActive('form')}>
                        <CustomToggle eventKey="Ad-Re" active={activeMenu === 'Ad-Re' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)}>
                            <i className="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Accordion.Collapse eventKey="Ad-Re" >
                            <ul className="sub-nav">
                                <li className="nav-item">
                                            ...
                                            <ul className="sub-nav">
                                                ...
                                                <li className="nav-item">
                                                    <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/List/programmes/">
                                                        ...
                                                        <i className="sidenav-mini-icon"> U </i>
                                                        <span className="item-name">Programme</span>
                                                    </Link>
                                                </li>
                                            </ul>
                                        </Accordion.Collapse>
                        ...
                        <div>
                            ...
                            <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix={`nav-item ${active === 'menustyle' ? 'active' : ''} `} onClick={() => setActive('menustyle')}  >
                                <CustomToggle eventKey="horizontal-menu" onClick={(activeKey) => setActiveMenu(activeKey)}>
                                    ...
                                    <span className="item-name">Rôles et Privilèges</span>
                                    <i className="right-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                        </svg>
                                    ...
                                    <ul className="sub-nav">
                                        ...
                                        <li className="nav-item">
                                            <Link className="nav-link " to="/Admin/list/roles" title={textrole}>
                                                ...
                                                <i className="sidenav-mini-icon"> D </i>
                                                <span className="item-name">Rôles</span>
                                            </Link>
                                        </li>
                                    ...
                                    <ul className="sub-nav">
                                        ...
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/dashboard/form/form-validation' ? 'active' : ''} nav-link`} to="/dashboard/form/form-validation">
                                                ...
                                                <i className="sidenav-mini-icon"> V </i>
                                                <span className="item-name">Parents</span>
                                            </Link>
                                        </li>
                                    </ul>
                                </Accordion.Collapse>
                            ...
                            <Accordion.Item as="li" eventKey="fondateur-vitrine" bsPrefix={`nav-item mb-5 ${active === 'icons' ? 'active' : ''} `} onClick={() => setActive('icons')}>
                                ...
                                <Accordion.Collapse eventKey="fondateur-vitrine">
                                    <ul className="sub-nav">
                                        ...
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/dashboard/icon/outline' ? 'active' : ''} nav-link`} to="/etablissement/edit/super/admin" >
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
