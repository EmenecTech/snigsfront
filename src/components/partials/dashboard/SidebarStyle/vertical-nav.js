            ...
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                        ...
                        <li className={`${location.pathname === '/dashboard' ? 'active' : ''} nav-item `}>
                         ...
                         <li className={`${location.pathname === '/dashboard' ? 'active' : ''} nav-item `}>
                            <Link className={`${location.pathname === '/dashboard' ? 'active' : ''} nav-link `} aria-current="page" to="/dashboard" onClick={() => { }}>
                                ...
                                <span className="item-name">{user.langue === "en" ? (<div>Dashboard</div>):(<div> Tableau de bords </div>)}</span>
                            </Link>
                        </li>
                ...
                {user.role === "Super adminstrateur" ? (<div>
                    ...
                    <li className={`nav-item`}>
                        <Link className={`nav-link`} aria-current="page" to="/utilisateurs/list/super/admin">
                            ...
                            <span className="item-name">{user.langue === "en" ? (<div>Users</div>):(<div> Utilisateur </div>)}</span>
                        </Link>
                    </li>
                    ...
                    <Accordion.Item as="li" eventKey="etablissements" bsPrefix={`nav-item ${active === 'menustyle' ? 'active' : ''} `} onClick={() => setActive('menustyle')}  >
                        <CustomToggle eventKey="etablissements" onClick={(activeKey) => setActiveMenu(activeKey)}>
                            ...
                            <span className="item-name">{user.langue === "en" ? (<div>Schools</div>):(<div> Etablissements </div>)}</span>
                            ...
                            <ul className="sub-nav">
                                <li className="nav-item">
                                    <Link className={`${location.pathname === '/etablissement/configurations/list/super/admin' ? 'active' : ''} nav-link`} to="/etablissement/configurations/list/super/admin">
                                        ...
                                        <span className="item-name"> {user.langue === "en" ? (<div>Configurations</div>):(<div> Configurations </div>)} </span>
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    ...
                                    <Link className="nav-link " to="/etablissement/list/Maternelle">
                                        ...
                                        <i className="sidenav-mini-icon"> D </i>
                                        <span className="item-name">{user.langue === "en" ? (<div>Nursery</div>):(<div> Maternelle </div>)}</span>
                                    </Link>
                                    <Link className="nav-link " to="/etablissement/list/Primaire">
                                        ...
                                        <i className="sidenav-mini-icon"> D </i>
                                        <span className="item-name">{user.langue === "en" ? (<div>Primary</div>):(<div> Primaire </div>)}</span>
                                    </Link>
                                    <Link className="nav-link " to="/etablissement/list/Secondaire">
                                        ...
                                        <i className="sidenav-mini-icon"> D </i>
                                        <span className="item-name">{user.langue === "en" ? (<div>Secondary</div>):(<div> Secondaire </div>)}</span>
                                    </Link>
                                    <Link className="nav-link " to="/etablissement/list/Universitaire">
                                        ...
                                        <i className="sidenav-mini-icon"> D </i>
                                        <span className="item-name">{user.langue === "en" ? (<div>University</div>):(<div> Universitaire </div>)}</span>
                                    </Link>
                                </li>
                                            ...
                                            <ul className="sub-nav">
                                                <li className="nav-item">
                                                    <Link className={`${location.pathname === '/dashboard/app/user-profile' ? 'active' : ''} nav-link`} to="/List/princriptions/">
                                                        ...
                                                        <span className="item-name">{user.langue === "en" ? (<div>Pre-registration</div>):(<div> Préinscription </div>)}</span>
                                                    </Link>
                                                </li>
                                            </ul>
                                        </Accordion.Collapse>
                                ...
                                <div>
                                    <Accordion.Item as="li" eventKey="sidebar-pedagogie" bsPrefix={`nav-item ${active === 'user' ? 'active' : ''} `} onClick={() => setActive('user')}>
                                        <CustomToggle eventKey="sidebar-pedagogie" onClick={(activeKey) => setActiveMenu(activeKey)}>
                                            ...
                                            <span className="item-name">{user.langue === "en" ? (<div>Pedagogy</div>):(<div> Pédagogie </div>)}</span>
                                            <i className="right-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                                </svg>
                                            ...
                                            <ul className="sub-nav">
                                                ...
                                                <li className="nav-item">
                                                    <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/List/Classes/Notes/">
                                                        ...
                                                        <i className="sidenav-mini-icon"> U </i>
                                                        <span className="item-name">{user.langue === "en" ? (<div>Notes</div>):(<div> Notes </div>)}</span>
                                                    </Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/List/filieres/">
                                                        ...
                                                        <i className="sidenav-mini-icon"> U </i>
                                                        <span className="item-name">{user.langue === "en" ? (<div>Branches</div>):(<div> Filières </div>)}</span>
                                                    </Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link className={`${location.pathname === '/dashboard/app/user-add' ? 'active' : ''} nav-link`} to="/List/classes/">
                                                        ...
                                                        <span className="item-name">{user.langue === "en" ? (<div>Class</div>):(<div> Classes </div>)}</span>
                                                    </Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/List/matieres/">
                                                        ...
                                                        <i className="sidenav-mini-icon"> U </i>
                                                        <span className="item-name">{user.langue === "en" ? (<div>Subjects</div>):(<div> Matières </div>)}</span>
                                                    </Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/Admin/List/Classes/Cours/">
                                                        ...
                                                        <i className="sidenav-mini-icon"> U </i>
                                                        <span className="item-name">{user.langue === "en" ? (<div>Course</div>):(<div> Cours </div>)}</span>
                                                    </Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/List/evaluations/">
                                                        ...
                                                        <i className="sidenav-mini-icon"> U </i>
                                                        <span className="item-name">{user.langue === "en" ? (<div>evaluations</div>):(<div> Evaluations </div>)}</span>
                                                    </Link>
                                                </li>
                                                <li className="nav-item">
                                            ...
                                            <ul className="sub-nav">
                                                <li className="nav-item">
                                                    <Link className={`${location.pathname === "/Admin/Comptabilite/List/" ? 'active' : ''} nav-link`} to="/Admin/Comptabilite/List/">
                                                        ...
                                                        <i className="sidenav-mini-icon"> U </i>
                                                        <span className="item-name">{user.langue === "en" ? (<div>Pension</div>):(<div> Pensions </div>)}</span>
                                                    </Link>
                                                </li>
                                                <li className="nav-item">
                ...
                </div>) : (<div></div>)}
                {
                    user.role === "Fondateur" || user.role === "Directeur" ? (
                        <div>
                            ...
                            <li className={`nav-item `}>
                                <Link className={` nav-link `} aria-current="page" to="/Admin/stat/" onClick={() => { }}>
                                    <i className="icon">
                                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z" fill="currentColor"></path>
                                            <path fillRule="evenodd" clipRule="evenodd" d="M4.53852 2H7.92449C9.32676 2 10.463 3.14585 10.463 4.55996V7.97452C10.463 9.38864 9.32676 10.5345 7.92449 10.5345H4.53852C3.13626 10.5345 2 9.38864 2 7.97452V4.55996C2 3.14585 3.13626 2 4.53852 2ZM4.53852 13.4655H7.92449C9.32676 13.4655 10.463 14.6114 10.463 16.0255V19.44C10.463 20.8532 9.32676 22 7.92449 22H4.53852C3.13626 22 2 20.8532 2 19.44V16.0255C2 14.6114 3.13626 13.4655 4.53852 13.4655ZM19.4615 13.4655H16.0755C14.6732 13.4655 13.537 14.6114 13.537 16.0255V19.44C13.537 20.8532 14.6732 22 16.0755 22H19.4615C20.8637 22 22 20.8532 22 19.44V16.0255C22 14.6114 20.8637 13.4655 19.4615 13.4655Z" fill="currentColor"></path>
                            ...
                            <li className={`nav-item `}>
                                <Link className={` nav-link `} aria-current="page" to="/Admin/list/" onClick={() => { }}>
                                    ...
                                    <span className="item-name">{user.langue === "en" ? (<div>Administration</div>):(<div> Administration </div>)}</span>
                                </Link>
                            </li>
                                ...
                                <Accordion.Collapse eventKey="horizontal-menu" >
                                    <ul className="sub-nav">
                                        <li className="nav-item" >
                                            <Link className={`${location.pathname === '/List/enseignants/' ? 'active' : '/List/enseignants/'} nav-link`} to="/List/enseignants/" title={textpriv}>
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i className="sidenav-mini-icon"> H </i>
                                                <span className="item-name"> {user.langue === "en" ? (<div>List of teachers</div>):(<div> Liste des enseignants </div>)} </span>
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className="nav-link " to="/Admin/list/presence/enseignant" title={textrole}>
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i className="sidenav-mini-icon"> D </i>
                                                <span className="item-name">{user.langue === "en" ? (<div>Presence of teachers</div>):(<div> Présence des enseignants </div>)}</span>
                                            </Link>
                                        </li>
                            ...
                            <Accordion.Item as="li" eventKey="sidebar-pedagogie" bsPrefix={`nav-item ${active === 'user' ? 'active' : ''} `} onClick={() => setActive('user')}>
                                    ...
                                    <ul className="sub-nav">
                                        ...
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/List/filieres/">
                                                ...
                                                <i className="sidenav-mini-icon"> U </i>
                                                <span className="item-name"> {user.langue === "en" ? (<div>Branch</div>):(<div> Filières</div>)}</span>
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/dashboard/app/user-add' ? 'active' : ''} nav-link`} to="/List/classes/">
                                        ...
                                        <li className="nav-item">
                                         ...
                                         <li className="nav-item">
                                            <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/List/groupes/">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i className="sidenav-mini-icon"> U </i>
                                                <span className="item-name">{user.langue === "en" ? (<div> Groups </div>):(<div> Groupes </div>)}</span>
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/Admin/List/Classes/Cours/">
                                        ...
                                        {confnotes.niveau_enseignement === "Universitaire" ? (<div>
                                            <li className="nav-item">
                                                <Link className={`${location.pathname === 'List/Uievaluations/' ? 'active' : ''} nav-link`} to="List/Uievaluations/">
                                                    <i className="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                            <g>
                                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                            ...
                                            <li className="nav-item">
                                                <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/List/indices/">
                                                    <i className="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                            <g>
                                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <li className="nav-item">
                                         ...
                                         <li className="nav-item">
                                            <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/Admin/Evaluation/Marks/Notes/">
                                                <i className="icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                        <g>
                                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                                ...
                                                <i className="sidenav-mini-icon"> U </i>
                                                <span className="item-name">{user.langue === "en" ? (<div>Report cards</div>):(<div> Bulletin de notes  </div>)}</span>
                                            </Link>
                                        </li>
                                    </ul>
                                </Accordion.Collapse>
                             ...
                             <Accordion.Item as="li" eventKey="sidebar-form-documents" bsPrefix={`nav-item ${active === 'form' ? 'active' : ''} `} onClick={() => setActive('form')}>
                                <CustomToggle eventKey="sidebar-form-documents" active={activeMenu === 'sidebar-form' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)}>
                                    ...
                                    <span className="item-name">{user.langue === "en" ? (<div>Documents</div>):(<div>Documents</div>)}</span>
                                    <i className="right-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                        </svg>
                            ...
                            <Accordion.Item as="li" eventKey="sidebar-comptabilite" bsPrefix={`nav-item ${active === 'user' ? 'active' : ''} `} onClick={() => setActive('user')}>
                                ...
                                <CustomToggle eventKey="sidebar-form" active={activeMenu === 'sidebar-form' ? true : false} onClick={(activeKey) => setActiveMenu(activeKey)}>
                                    ...
                                    <span className="item-name">{user.langue === "en" ? (<div>Discipline</div>):(<div> Discipline </div>)} </span>
                                    <i className="right-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                        </svg>
                                    ...
                                    <ul className="sub-nav">
                                        <li className="nav-item">
                                            <Link className={`${location.pathname === '/etablissement/edit/super/admin' ? 'active' : ''} nav-link`} to="/etablissement/edit/super/admin" >
                                                ...
                                                <span className="item-name">{user.langue === "en" ? (<div>Informations</div>):(<div> Informations </div>)}</span>
                                            </Link>
                                        </li>
...

                {
                    user.role === "Elève" ? (<div>
                                ...
                                <ul className="sub-nav">
                                    ...
                                    <li className="nav-item">
                                        <Link className={`${location.pathname === 'badge' ? 'active' : ''} nav-link`} to="badge">
                                            ...
                                            <i className="sidenav-mini-icon"> U </i>
                                            <span className="item-name">{user.langue === "en" ? (<div>Badge</div>):(<div> Badge </div>)}</span>
                                        </Link>
                                    </li>
                        ...
                        <li className="nav-item">
                            ...
                            >
                                ...
                                <span className="item-name">{user.langue === "en" ? (<div>Forum</div>):(<div> Forum </div>)}</span>
                            </Link>
                        </li>
                                ...
                                <ul className="sub-nav">
                                    ...
                                    <li className="nav-item">
                                        <Link className={`${location.pathname === '/Eleve/List/Planning/' ? 'active' : ''} nav-link`} to="/Eleve/List/Planning/">
                                            ...
                                            <i className="sidenav-mini-icon"> U </i>
                                            <span className="item-name">{user.langue === "en" ? (<div>Timetable</div>):(<div> Emploi du temps </div>)}</span>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className={`${location.pathname === '/Eleve/List/Matieres/Cours' ? 'active' : ''} nav-link`} to="/Eleve/List/Matieres/Cours">
                        ...
                        <li className="nav-item">
                            ...
                            >
                                ...
                                <span className="item-name">{user.langue === "en" ? (<div>Request</div>):(<div> Requetes </div>)}</span>
                            </Link>
                        </li>
                        <Accordion.Item as="li" eventKey="sidebar-documentscolaires" bsPrefix={`nav-item ${active === 'user' ? 'active' : ''} `} onClick={() => setActive('user')}>
                            <CustomToggle eventKey="sidebar-documentscolaires" onClick={(activeKey) => setActiveMenu(activeKey)}>
                                ...
                                <ul className="sub-nav">
                                    ...
                                    <li className="nav-item">
                                        <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/Eleve/List/Documents/">
                                            ...
                                            <i className="sidenav-mini-icon"> U </i>
                                            <span className="item-name">{user.langue === "en" ? (<div>School certificate</div>):(<div> Certificat de scolarité </div>)}</span>
                                        </Link>
                                    </li>
                        ...
                        <li className="nav-item">
                            ...
                            >
                                ...
                                <span className="item-name">{user.langue === "en" ? (<div>Regularities</div>):(<div> Régularités </div>)}</span>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link
                    ...
                    user.role === "Parent" ? (<div>
                        ...
                        <li className="nav-item">
                            <Link
                                className={`${location.pathname === 'Parent/Discipline/Info' ? "active" : ""} nav-link `}
                                aria-current="page"
                                to={"Parent/Discipline/Info"}
                            >
                                <i className="icon">
                                    <svg
                                        width="20"
                        ...
                        <li className="nav-item">
                            ...
                            >
                                ...
                                <span className="item-name">{user.langue === "en" ? (<div>Request</div>):(<div> Requêtes </div>)}</span>
                            </Link>
                        </li>
                        <Accordion.Item as="li" eventKey="sidebar-documentscolaires" bsPrefix={`nav-item ${active === 'user' ? 'active' : ''} `} onClick={() => setActive('user')}>
                            <CustomToggle eventKey="sidebar-documentscolaires" onClick={(activeKey) => setActiveMenu(activeKey)}>
                ...
                {user.role === "Professeurs" ? (
                    ...
                    <div>
                        ...
                        <Accordion.Item as="li" eventKey="sidebar-professeur-pedagogie" bsPrefix={`nav-item ${active === 'Classes' ? 'active' : ''} `} onClick={() => setActive('Classes')}  >
                            <CustomToggle eventKey="sidebar-professeur-pedagogie" onClick={(activeKey) => setActiveMenu(activeKey)}>
                                <i className="icon">
                                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.9488 14.54C8.49884 14.54 5.58789 15.1038 5.58789 17.2795C5.58789 19.4562 8.51765 20.0001 11.9488 20.0001C15.3988 20.0001 18.3098 19.4364 18.3098 17.2606C18.3098 15.084 15.38 14.54 11.9488 14.54Z" fill="currentColor"></path>
                                        <path opacity="0.4" d="M11.949 12.467C14.2851 12.467 16.1583 10.5831 16.1583 8.23351C16.1583 5.88306 14.2851 4 11.949 4C9.61293 4 7.73975 5.88306 7.73975 8.23351C7.73975 10.5831 9.61293 12.467 11.949 12.467Z" fill="currentColor"></path>
                            ...
                            <Accordion.Collapse eventKey="sidebar-professeur-pedagogie" >
                                <ul className="sub-nav">
                                    <li className="nav-item">
                                        <Link className={`${location.pathname === '/dashboard_professeur/cours_classe' ? 'active' : ''} nav-link`} to="/Enseignant/Planning/">
                                            <i className="icon">
