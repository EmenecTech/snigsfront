...
const ElevelistdocumentsEleves = memo((props) => {
    ...
    const submitData = (e) => {
        ...
        Axios.post("http://127.0.0.1:8000/api/document/add/" + etab + "/" + userid, fData)
            .then((res) => {
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Eleve/Load/Documents/" + item.id} >
