                                                                    ...
                                                                    <Row style={{ fontSize: "10px" }}>
                                                                        <Col sm="4" lg="4">
                                                                            <div className="mt-2">
                                                                                ...
                                                                                <p style={{ fontSize: "10px" }} className="mb-1">Date and of place of birth : {elevesinclass.date_naissance} à {elevesinclass.lieu_naissance}</p>
                                                                                <p style={{ fontSize: "10px" }} className="mb-1">Gender : {elevesinclass.sexe}</p>
                                                                                <p style={{ fontSize: "10px" }} className="mb-1">Registration Number : {elevesinclass.matricule}</p>
                                                                            </div>
                                                                        </Col>
                                                                        <Col sm="4" lg="4">
                                                                            <div className="mt-2">
                                                                                <p style={{ fontSize: "10px" }} className="mb-0">Classe : {elevesinclass.other_in_user} </p>
