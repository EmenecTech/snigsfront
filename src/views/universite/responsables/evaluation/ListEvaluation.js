...
const ListEvaluation = memo((props) => {
                                ...
                                >
                                    <thead>
                                        <tr>
                                            ...
                                            <th> {user.langue === "en" ? (<div>SN value (in percent)</div>):(<div>Valeur de la SN(En pourcentage)</div>)}</th>
                                            <th> {user.langue === "en" ? (<div>CC value (in percent)</div>):(<div>Valeur du CC(En pourcentage)</div>)}</th>
                                    ...
                                    <tbody>
                                        {evaluations_list.map((item) => (
                                            <tr key={item.id}>
                                                ...
                                                <td>{item.sn_evaluation}%</td>
                                                <td>{item.cc_evaluation}%</td>
