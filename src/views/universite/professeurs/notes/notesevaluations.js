...
const ProfesseurListEvaluations = memo((props) => {
                    ...
                    <Card>
                        <Card.Header className="d-flex justify-content-between">
                            <div className="header-title">
                                <h4 className="card-title"><th>{user.langue === "en" ? (<div> Assessments </div>):(<div>Evaluations</div>)}</th></h4>
                            </div>
                            <div>
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Professeur/List/Notes/" + item.intitule_evaluation + "/" + niveau + "/" + classe + "/" + matiere}>
...
export default ProfesseurListEvaluations
