...
const ParentsListEvaluationsNotes = memo((props) => {
          ...
          <Card>
            <Card.Header className="d-flex justify-content-between">
              <div className="header-title">
                <h4 className="card-title">{user.langue === "en" ? (<div> evaluations </div>):(<div> évaluations </div>)}</h4>
              </div>
            </Card.Header>
            <Card.Body>
              <div className="table-responsive border-bottom my-3">
                ...
                >
                  <thead>
                    <tr>
                      <th>Intitulé</th>
                      <th>{user.langue === "en" ? (<div> evaluation type </div>):(<div> type d'évaluation </div>)}</th>
...
export default ParentsListEvaluationsNotes;
