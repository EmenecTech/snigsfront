...
const ParentsBulletinMaternelle = memo((props) => {
    ...
    {/* Bulletin standard de la maternelle francophone */}
                                                ...
                                                <Row>
                                                    <Col sm="12" lg="12">
                                                        <Card>
                                                            ...
                                                            <Col sm="4" lg="4">
                                                                        <div className="mt-1">
                                                                            <p >Nom et Prénom : {elevesinclass.nom} {elevesinclass.prenom} <br />
                                                                    ...
                                                                    <Col sm="4" lg="4">
                                                                        ...
                                                                        <div className="mt-1">
                                                                            <p >Name :  {elevesinclass.nom} {elevesinclass.prenom} <br />
                                                                                Date and place of birth :  {elevesinclass.date_naissance} à {elevesinclass.lieu_naissance} <br />
    ...
    export default ParentsBulletinMaternelle
