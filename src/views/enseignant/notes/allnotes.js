...
const AllNotes = memo((props) => {
    ...
    const evaluation6 = "Sequence 6";
    const evaluation5 = "Sequence 5";
    const evaluation4 = "Sequence 4";
    const evaluation3 = "Sequence 3";
    const evaluation2 = "Sequence 2";
    const evaluation1 = "Sequence 1";
    ...
    const fetchAllNotes6 = () => {
        http.get('/notesseq6_eleves/' + etab + '/' + classe + "/" + matiere + "/" + evaluation6).then(res => {
            setNotes6(res.data);
    ...
    const fetchAllNotes5 = () => {
        http.get('/notesseq5_eleves/' + etab + '/' + classe + "/" + matiere + "/" + evaluation6).then(res => {
            setNotes5(res.data);
    ...
    const fetchAllNotes4 = () => {
        http.get('/notesseq4_eleves/' + etab + '/' + classe + "/" + matiere + "/" + evaluation6).then(res => {
            setNotes4(res.data);
    ...
    const fetchAllNotes3 = () => {
        http.get('/notesseq3_eleves/' + etab + '/' + classe + "/" + matiere + "/" + evaluation6).then(res => {
            setNotes3(res.data);
    ...
    const fetchAllNotes2 = () => {
        http.get('/notesseq2_eleves/' + etab + '/' + classe + "/" + matiere + "/" + evaluation6).then(res => {
            setNotes2(res.data);
    ...
    const fetchAllNotes1 = () => {
        http.get('/notesseq1_eleves/' + etab + '/' + classe + "/" + matiere + "/" + evaluation6).then(res => {
            setNotes1(res.data);
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <table className="table">
                                <thead>
                                    <tr>
                                        <th>{user.langue === "en" ? (<div> Students </div>):(<div> Elèves </div>)}</th>
                                        <th>Sequence 1</th>
                                        <th>Sequence 2</th>
                                        <th>Sequence 3</th>
                                        <th>Sequence 4</th>
