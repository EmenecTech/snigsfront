...
const EnseignantListEleves = memo((props) => {
    ...
    const {niveau, classe, evaluation} = useParams();
                    ...
                    <Card>
                        <Card.Header className="d-flex justify-content-between">
                            <div className="header-title">
                                <h4 className="card-title">{user.langue === "en" ? (<div> Students </div>):(<div> Elèves </div>)}</h4>
                            </div>
                                            ...
                                            <tr key={user.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Enseignant/List/Eleves/Groupes/" + niveau + "/" + classe + "/" + evaluation + "/" + user.id }>
