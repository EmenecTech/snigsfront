...
const Enseignant_cdtexte_matieres = memo((props) => {
                    ...
                    <Card>
                        <Card.Header className="d-flex justify-content-between">
                            <div className="header-title">
                                <h4 className="card-title">{user.langue === "en" ? (<div> classes </div>):(<div> classes </div>)}</h4>
                            </div>
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Enseignant/Text/Book/Periodes/Matieres/" + item.classe_cp + "/" + item.matiere_cp}>
...
export default Enseignant_cdtexte_matieres
