...
const Enseignant_matieres_chapitres = memo((props) => {
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Enseignant/List/Chapitres/" + item.classe_cp + "/" + item.matiere_cp}>
...
export default Enseignant_matieres_chapitres
