...
const ListPrivileges = memo((props) => {
    ...
    const submitForm = () => {
        http.post('/privileges', inputs).then((res) => {
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/superAdmin/edit/privileges/" + item.id} >
                                                            <span className="btn-inner">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete" to="#" onClick={() => { deletePrivilege(item.id) }}>
                                                            <span className="btn-inner">
