...
const MembresAdministration = () => {
    ...
    const fetchAllMembres = () => {
        http.get('/get_membres/' + etab).then(res => {
            setMembres(res.data);
        })
    }
                                                    ...
                                                    <tr key={idx}>
                                                        ...
                                                        <td>
                                                            <div className="flex align-items-center list-user-action">
                                                               ...
                                                               <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Admin/edit/membres_administration/" + item.id}>
                                                                    <span className="btn-inner">
...
export default MembresAdministration;
