...
const ClassesProgrammes = memo((props) => {
    ...
    const deleteClasses = (id) => {
        http.delete('/delete_programme_classe/' + id).then(res => {
            fetchAllclasses();
        })
    }
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete" to="#" onClick={() => { deleteClasses(item.id) }}>
                                                            <span className="btn-inner">
