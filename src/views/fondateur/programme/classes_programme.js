...
const ClassesProgrammes = memo((props) => {
    ...
    const handleChange = (event) => {
        ...
        setInputs(values => ({ ...values, [name]: value, etab, idprogramme }))
    }
    ...
    const fetchAllclasses = () => {
        http.get('/list_programme/' + etab + '/' + idprogramme).then(res => {
            setclasses(res.data);
        })
    }
    ...
    useEffect(() => {
        fetchAllclasseselect();
    }, []);

    const fetchAllclasseselect = () => {
        http.get('/get_classes/' + etab).then(res => {
            setclasseselect(res.data);
        })
    }
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Edit/programmes/" + item.niveau_classe + "/" + item.intitule_classe + "/" + idprogramme}>
                                                            <span className="btn-inner">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete" to="#" onClick={() => { deleteClasses(item.classe_programmeclasse, item.programme_programmeclasse) }}>
                                                            <span className="btn-inner">
...
export default ClassesProgrammes
