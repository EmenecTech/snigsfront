...
const ListProgramme = memo((props) => {
    ...
    const submitForm = () => {
        http.post('/programme', inputs).then((res) => {
            alert("Programme ajouté avec succès !")
            navigate('/List/programmes/')
    ...
    const fetchAllevaluations = () => {
        http.get('/get_programmes/' + etab).then(res => {
                                ...
                                >
                                    ...
                                    <tbody>
                                        {evaluations_list.map((item) => (
                                            <tr key={item.id}>
                                                <td>{item.intitule_programme}</td>
                                                <td>{item.type_programme}</td>
                                                <td>
                                                    <div className="flex align-items-center list-user-action">

                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Classes/programmes/" + item.id}>
                                                            <span className="btn-inner">
