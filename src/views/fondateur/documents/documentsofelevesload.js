...
const AdminlistdocumentsOfEleves = memo((props) => {
    ...
    const fetchAlldocuments = () => {
        http.get('/documents/of/eleve/' + ideleve + '/' + idoc).then(res => {
...
export default AdminlistdocumentsOfEleves
