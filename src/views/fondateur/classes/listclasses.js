                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    {confnotes.niveau_enseignement === "Universitaire" ? (<div>
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" to={"/Details/Universite/classe/" + item.niveau_classe + "/" + item.intitule_classe}>
                                                            <span className="btn-inner">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete" onClick={() => { deleteClasses(item.intitule_classe) }}>
                                                            <span className="btn-inner">
