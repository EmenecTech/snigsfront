                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    {confnotes.niveau_enseignement === "Universitaire" ? (<div>
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" to={"/Details/classePrim/" + item.niveau_classe + "/" + item.intitule_classe}>
                                                            <span className="btn-inner">
