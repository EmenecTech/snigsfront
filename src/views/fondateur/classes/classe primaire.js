                                                        ...
                                                        <tr key={item.id}>
                                                            ...
                                                            <td>
                                                                <div className="flex align-items-center list-user-action">
                                                                    ...
                                                                    <Link className="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete" >
                                                                        <span className="btn-inner">
                            ...
                            <Tab.Pane eventKey="fourth" id="profile-friends">
                                <Card>
                                    <Card.Header className="d-flex justify-content-between">
                                        ...
                                        <Modal show={show} onHide={handleClose}>
                                            <Modal.Header closeButton>
                                                <Modal.Title as="h5"> {user.langue === "en" ? (<div> Add course to class </div>):(<div> Ajouter un groupe à la classe </div>)}</Modal.Title>
                                            </Modal.Header>
                                            <Modal.Body>
                                                <Form>
