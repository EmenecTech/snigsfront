...
const ListMatieres = memo((props) => {
    ...
    const submitForm = () => {
        http.post('/matieres', inputs).then((res) => {
            alert("Matière ajoutée avec succès !")
            navigate('/List/matieres/')
    ...
    const fetchAllfilieres = () => {
        http.get('/get_matieres/' + etab).then(res => {
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Edit/matieres/" + item.id}>
                                                            <span className="btn-inner">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete" to="#" onClick={() => { deleteMatieres(item.id) }} >
                                                            <span className="btn-inner">
