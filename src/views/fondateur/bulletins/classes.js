                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Admin/Bulletin/" + evaluation +  "/" + item.intitule_classe + "/Eleve"}>
