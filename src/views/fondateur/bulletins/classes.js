...
const AdminEvaluationListClasses = memo((props) => {
    ...
    const deleteClasses = (intitule_classe) => {
        http.delete('/delete_classes/' + intitule_classe).then(res => {
            fetchAllclasses();
        })
    }
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Admin/Bulletin/" + evaluation +  "/" + item.niveau_classe + "/" + item.intitule_classe + "/Eleve"}>
...
export default AdminEvaluationListClasses
