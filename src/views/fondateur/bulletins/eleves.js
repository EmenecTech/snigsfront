...
const AdminEvaluationListClassesEleves = memo((props) => {
    ...
    const {classe, evaluation, userid} = useParams();
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    ...
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Admin/Bulletin/" + evaluation + "/"  + item.fonction_in_user  + "/" + item.other_in_user + "/" + item.id }>
...
export default AdminEvaluationListClassesEleves
