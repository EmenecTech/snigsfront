...
const [allnotespf, setAllNotespf] = useState([]);
 ...
 const [allind, setAllInd] = useState([]);
    ...
    const fetchAllNotessf = () => {
        http.get('/all_notes_sf/' + etab + '/' + classe + "/" + evaluation + '/Matières Littéraires/' + userid).then(res => {
    ...
    const fetchAllNotessf1 = () => {
        http.get('/all_notes_sf1/' + etab + '/' + classe + "/" + evaluation + '/Matières Scientifiques/' + userid).then(res => {
    ...
    const fetchAllNotessf2 = () => {
        http.get('/all_notes_sf2/' + etab + '/' + classe + "/" + evaluation + '/Matières Complémentaires/' + userid).then(res => {
