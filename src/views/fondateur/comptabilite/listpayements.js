...
const ListPensions = memo((props) => {
    ...
    const submitForm = () => {
        ...
        http.post('/payements', inputs).then((res) => {
            navigate('/Admin/Comptabilite/List/')
    ...
    const fetchAllpayements = () => {
        http.get('/get_payements/' + etab).then(res => {
                            ...
                            <div className="table-responsive border-bottom my-3">
                                ...
                                >
                                    ...
                                    <tbody>
                                        {payements.map((item) => (
                                            <tr key={item.id}>
                                                <td>{item.intitule_pension}</td>
                                                <td>{item.montant_pension} XAF</td>
                                                <td>{item.tranches_pension}</td>
                                                <td>{item.debut_payement_pension}</td>
                                                <td>{item.fin_payement_pension}</td>
                                                <td>
                                                    <div className="flex align-items-center list-user-action">

                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Admin/Comptabilite/Edit/" + item.id}>
                                                            <span className="btn-inner">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete" to="#" onClick={() => { deletePayements(item.id) }}>
                                                            <span className="btn-inner">
