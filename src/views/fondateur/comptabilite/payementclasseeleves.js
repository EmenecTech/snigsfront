...
const PayementsListNiveauClasseEleves = memo((props) => {
    ...
    const idpension = infopayement.idpension_classepension
    ...
    const fetchAllclasses = () => {
        http.get('/fetch/niveau/classe/' + etab + '/' + niveau).then(res => {
            setclasses(res.data);
        })
    }
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <div className="flex align-items-center list-user-action">
                                                        ...
                                                        <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Payements/List/Eleve/Classes/" + niveau + "/" + classe + "/" + item.ideleve_payementsum + "/" + idpension}>
...
export default PayementsListNiveauClasseEleves
