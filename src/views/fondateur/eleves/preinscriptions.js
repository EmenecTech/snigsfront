...
const ListPreinscriptions = memo((props) => {
    ...
    const fetchAllpreinscriptions = () => {
        http.get('/get_preinscriptions/' + etab).then(res => {
            setpreinscriptions(res.data);
        })
    }
                                    ...
                                    <Form>
                                        ...
                                        <Row>
                                            <Col>
                                                <Form.Group as={Row} className="form-group">
                                                    <Form.Group className="form-group">
                                                        <Form.Label htmlFor="exampleInputText1">Sexe </Form.Label>
                                                        <select name="genre" className="form-select" onChange={handleChange} >
                                                            <option></option>
                                            ...
                                            <Col>
                                                <Form.Group as={Row} className="form-group">
                                                    <Form.Group className="form-group">
                                                        ...
                                                        <Form.Control type="mail" defaultValue="" name="email" onChange={handleChange} required />
                                                    </Form.Group>
                                                </Form.Group>
                                            </Col>
                                        </Row>
                                                ...
                                                <tr key={idx}>
                                                    ...
                                                    <td>
                                                        <div className="flex align-items-center list-user-action">
                                                            ...
                                                            <Link className="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" to={"/Inscription/" + item.fonction_user + "/" + item.id}>
                                                                <span className="btn-inner">
...
export default ListPreinscriptions
