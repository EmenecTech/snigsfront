                                            ...
                                            <Col>
                                                <Form.Group as={Row} className="form-group">
                                                    <Form.Group className="form-group">
                                                        <Form.Label htmlFor="exampleInputText1">Choisissez le privilège </Form.Label>
                                                        <select className="form-select mb-3 shadow-none" name="code" onChange={handleChange}>
                                                            <option></option>
                                                            {privileges.map((item) => (
                                                                <option key={item.id} value={item.code_privilege}>{item.intitule_privilege}</option>
                                                            ))}
